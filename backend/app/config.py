...
class Settings(BaseSettings):
    ...
    subtitle_cache_ttl_seconds: int = Field(300, ge=0, validation_alias="FBC_SUBTITLE_CACHE_TTL_SECONDS")
    ...
    embed_preview_clip_seconds: int = Field(300, ge=0, le=900, validation_alias="FBC_EMBED_PREVIEW_CLIP_SECONDS")
