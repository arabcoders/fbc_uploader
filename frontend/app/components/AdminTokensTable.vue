          ...
          <template #header>
            <div class="flex items-center justify-between gap-2">
              <div class="flex items-center gap-2 min-w-0">
                <NuxtLink
                  :to="`/${token.disabled ? 'f' : 't'}/${token.token}`"
        ...
        <table class="w-full divide-y divide-default">
          <thead class="bg-elevated">
            <tr>
              ...
              <th class="px-4 py-3 text-left text-sm font-semibold text-highlighted w-24">
                Status
              </th>
              <th class="px-4 py-3 text-right text-sm font-semibold text-highlighted w-48">
                Actions
              </th>
            </tr>
          </thead>
              ...
              <td class="px-4 py-3 text-sm">
                <div class="space-y-1.5">
                  <div class="flex items-center gap-2">
                    <NuxtLink :to="`/${token.disabled ? 'f' : 't'}/${token.token}`">{{
                      token.token
                    }}</NuxtLink>
