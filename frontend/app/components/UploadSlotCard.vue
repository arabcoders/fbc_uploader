    ...
    <div class="space-y-4">
      ...
      <div class="space-y-2">
        <div class="flex gap-2">
          <UButton
            v-if="!uploadSlot.working && !uploadSlot.paused"
            :disabled="!uploadSlot.file || uploadSlot.errors.length > 0"
            color="primary"
        ...
        <UAlert
          v-if="uploadSlot.file && uploadSlot.errors.length > 0"
          color="error"
          variant="subtle"
